...
L["Compare with"] = "vergleiche mit" -- Needs review
...
L["Other"] = "Andere"
L["Other characters"] = "andere Charaktere" -- Needs review
L["Other guilds"] = "andere Gilden" -- Needs review
...
L["TIME_TO_NEXT_WARNING_TEXT"] = "Zeit bis zur nächsten Benachrichtigung" -- Needs review
L["TIME_TO_NEXT_WARNING_TOOLTIP"] = "Mindest Zeitlimit, bevor Du die nächste 'Post verfällt' Warnung angezeigt bekommst." -- Needs review
...
L["Use color-coding for recipes at the AH"] = "Benutze Einfärbung für Rezepte im Auktionshaus" -- Needs review
L["Use color-coding for recipes at vendors"] = "Benutze Einfärbung für Rezepte bei Händlern" -- Needs review
