...
-------------------------------
DBM = {
	Revision = ("$Revision: 6075 $"):sub(12, -3),
	Version = "4.92",
	DisplayVersion = "4.93 alpha", -- the string that is shown as version
	ReleaseRevision = 6059 -- the revision of the latest stable version that is available (for /dbm ver2)
}
