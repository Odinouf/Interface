...
-------------------------------
DBM = {
	Revision = ("$Revision: 6221 $"):sub(12, -3),
	Version = "4.94",
	DisplayVersion = "4.94", -- the string that is shown as version
	ReleaseRevision = 6221 -- the revision of the latest stable version that is available (for /dbm ver2)
}
