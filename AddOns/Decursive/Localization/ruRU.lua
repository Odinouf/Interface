...
if not L then
    T._LoadedFiles["ruRU.lua"] = "2.7.0.3";
    return;
end;
...
L["OPT_MUFMOUSEBUTTONS"] = "Кнопки мыши" -- Needs review
L["OPT_MUFMOUSEBUTTONS_DESC"] = [=[Задать кнопки мыши для использования с каждым цветом оповещения микро-фреймов игроков.
Перед изменением этой вкладки вы должны проверить '|cFFFF5533Настройки лечения|r'!]=] -- Needs review
L["OPT_MUFSCOLORS"] = "Цвета"
L["OPT_MUFSCOLORS_DESC"] = "Изменить цвета микро-фреймов игроков." -- Needs review
...
L["OPT_OPTIONS_DISABLED_WHILE_IN_COMBAT"] = "Эти настройки отключаются во время боя." -- Needs review
