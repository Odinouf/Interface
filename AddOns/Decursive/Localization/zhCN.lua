...
if not L then
    T._LoadedFiles["zhCN.lua"] = "2.7.0.3";
    return;
end;
...
L["OPT_CURINGOPTIONS_DESC"] = "关于净化过程的选项设置" -- Needs review
...
（如要更改顺序，反选所有类型并再次检查所需顺序）]=] -- Needs review
L["OPT_CURINGORDEROPTIONS"] = "净化类型和优先级"
L["OPT_CURSECHECK_DESC"] = "选中后你将可以查看和净化受到诅咒效果影响的单位"
L["OPT_CUSTOMSPELLS"] = "自定义法术"
L["OPT_CUSTOMSPELLS_DESC"] = "这里添加法术扩展 Decursive 的自动配置。" -- Needs review
L["OPT_CUSTOMSPELLS_EFFECTIVE_ASSIGNMENTS"] = "有效法术分配：" -- Needs review
...
L["OPT_CUSTOM_SPELL_MACRO_MISSING_NOMINAL_SPELL"] = "法术%q必须位于宏之中。" -- Needs review
...
-  可能不会改变宏使用的法术，另外 Decursive 将无法追踪其冷却时间或范围状态。]=] -- Needs review
...
L["OPT_MFSETTINGS_DESC"] = "微单元框体选项" -- Needs review
L["OPT_MUFFOCUSBUTTON"] = "焦点按钮："
L["OPT_MUFHANDLE_HINT"] = "移动微单元框体：在第一个微单元框体之上 Alt+点击不可见表头。"
L["OPT_MUFMOUSEBUTTONS"] = "鼠标绑定"
L["OPT_MUFMOUSEBUTTONS_DESC"] = [=[设置每个微单元框体鼠标按钮的警报颜色。
更改此项之前请检查|cFFFF5533净化选项|r！]=] -- Needs review
L["OPT_MUFSCOLORS"] = "颜色"
L["OPT_MUFSCOLORS_DESC"] = "更改关于微单元框体的颜色" -- Needs review
