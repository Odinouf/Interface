...
L["Adjust the font size of countdown and application count texts."] = "Größe der Schriftart der Cooldowns und der Stackzähler"
...
L["Dispel"] = "Entzaubern"
L["Display a colored border. Its color depends on the kind and owner of the (de)buff."] = "Zeige einen eingefärbten Rand. Die Farbe basiert auf die Art und des Besitzers des (de)buffes "
L["Display the Blizzard shiny, animated border."] = "Zeige den animierten und leuchtenden Blizzard Aktionsbuttonrand an"
L["Do not display (de)buff application count in the action buttons."] = "Zeige keinen (de)buff Stackzähler im Aktionsbutton an"
L["Do not display the remaining time countdown in the action buttons."] = "Zeige nicht die restliche Zeit des Cooldowns im Aktionsbutton an"
...
L["Enabled"] = "Aktiviert"
L["Enter one name per line. They are spell-checked ; errors will prevents you to validate."] = "Ein Name pro Zeile eingeben. Zauber werden überprüft; Fehler werden zur korrektur angezeigt. "
L["Font effect"] = "Schrifteffekt"
L["Font name"] = "Schriftartname"
L["Font size"] = "Schriftgröße"
L["Glowing animation"] = "Leuchtende Animation"
L["Health threshold"] = "Healschwelle"
L["Hide the application count text for this spell."] = "Verstecke des Stackzähler für diesen Zauber"
L["Hide the countdown text for this spell."] = "Verstecke den Cooldowntext für diesen Zauber"
L["Highlight"] = "Hervorheben"
L["Highlight threshold"] = "Schwelle vervorheben"
...
L["Invert"] = "Umkehren"
L["Invert the highlight condition, highlightning when the (de)buff is not found."] = "Drehe die Hervorhebungskonditionen um. Hervorheben, wenn der (de)buff nicht gefunden wurde"
L["Left"] = "Links"
...
L["Only display the (de)buff if it has been applied by yourself, your pet or your vehicle."] = "Zeige nur (de)buffs an, die durch dich, dein Pet oder dein Fahrzeug verursacht wurden"
L["Only my buffs"] = "Nur meine Buffs"
L["Only my debuffs"] = "Nur meine Debuffs"
L["Only show mine"] = "Nur meine zeigen"
L["Options related to the units to watch and the way to select them depending on the spells."] = "Einstellungen im Verhältniss zur jeweiligen Ressource um die abhängig von Zaubern auszuwählen."
L["Others' buffs"] = "Buffs anderer"
L["Others' debuffs"] = "Debuffs anderer"
L["Outline"] = "Schrifthintergrund"
L["Power threshold"] = "Power schwelle"
...
L["Self"] = "Selbst"
L["Should the countdown provided by this module be displayed ?"] = "Soll der Cooldown von diesem Modul beteitgestellt, hervorgehoben werden ?"
L["Should the module be used ?"] = "Soll das Modul benutzt werden ?"
L["Should the stack count provided by this module be displayed ?"] = "Soll der Stackzähler von diesem Modul beteitgestellt, hervorgehoben werden ?"
...
L["The kind of settings to use for the spell."] = "Die Art der Einstellungen für diesen Zauber nutzen"
L["The large font is used to display countdowns."] = "Die große Schrift wird zur Anzeige von Countdowns verwendet."
L["The small font is used to display application count."] = "Die kleine Schriftart wird vom Stackzägler genutzt"
...
L["Watch (de)buff changes on the unit under the mouse cursor. Required only to properly update macros that uses @mouseover targeting."] = "Betrachte (de)buff - Veränderungen an den per Maus anvisierten Einheiten. Benötigt ein Updatemakto, das über @mouseover anvisiert."
L["Watch (de)buff changes on your focus. Required only to properly update macros that uses @focus targeting."] = "Beobachte  (de)buff - Veränderungen auf deinem Focus. Benötigt ein geeignetes Macro, das mit @focus anvisiert"
...
L["display special values that are not (de)buffs."] = "Zeige spezielle Wertde, die keine (de)buffs sind"
...
L["spells from matching spellbooks."] = "Zauber an Zauberbuch anpassen"
...
L["watch pet (de)buffs in any case."] = "Beobachte Pet (de)buffs auf irgendeine Art"
L["watch your (de)buffs in any case."] = "Beobachte eigene (de)buffs auf irgendeine Art"
...
L["Dispel"] = "해제"
L["Display a colored border. Its color depends on the kind and owner of the (de)buff."] = "색상화된 테두리를 표시합니다. 색상은 자신의 오라의 종류에 따라 결정됩니다."
