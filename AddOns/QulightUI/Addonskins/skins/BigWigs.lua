...
if Qulight["actionbar"].buttonsize and type(Qulight["actionbar"])=="number" then
	buttonsize=Qulight["actionbar"].buttonsize-2
else
...
local function registerStyle()
	...
	if prox and skinrange and BigWigs.pluginCore.modules.Bars.db.profile.barStyle == "BigWigs" then
		hooksecurefunc(BigWigs.pluginCore.modules.Proximity, "RestyleWindow", function()
			frame1px(BigWigsProximityAnchor)
			if drawshadow then
