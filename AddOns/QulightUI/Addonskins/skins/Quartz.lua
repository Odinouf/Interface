if not Mod_AddonSkins or not IsAddOnLoaded("Quartz") or not Qulight["addonskins"].Quartz == true then return end
...
Mod_AddonSkins:RegisterSkin("Quartz",function(Skin, skin, Layout, layout, config)
	...
	Skin.SkinQuartzBar = function(self, bar)
		...
		-- Fonts
		bar.Text:SetFont(Qulight["media"].font,bar.config.fontsize)
		bar.TimeText:SetFont(Qulight["media"].font,bar.config.timefontsize)
		-- Bar Texture
