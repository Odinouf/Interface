if not Mod_AddonSkins or not Skada or not Qulight["addonskins"].Skada== true then return end
local Skada = Skada
...
Mod_AddonSkins:RegisterSkin("Skada",function(Skin,skin,Layout,layout,config)
    ...
    if not Skada.nofont or Skada.nofont ~= true then
	...
	barmod.ApplySettings = function(self, win)
		...
		if win.bargroup.bgframe then
            skin:SkinBackgroundFrame11(win.bargroup.bgframe)
