...
--adjust Qulight["media"].font size whenever the timer's parent size changes
...
local function Timer_OnSizeChanged(self, width, height)
	...
	if fontScale < MIN_SCALE then
		...
		self.text:SetFont(Qulight["media"].pxfont, fontScale * FONT_SIZE, 'OUTLINE')
