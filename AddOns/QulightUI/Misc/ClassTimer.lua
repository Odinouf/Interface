...
do
	...
	CreateFramedTexture = function( parent )
		...
		result:SetTexture(unpack(Qulight["media"].backdropcolor));
		border:SetTexture(unpack(Qulight["media"].bordercolor));
		background:SetTexture(unpack(Qulight["media"].backdropcolor));
