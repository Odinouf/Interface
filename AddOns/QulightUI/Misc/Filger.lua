...
ns.Filger_Spells = {
	...
	--[[	{
		...
		},
		{
			...
			--4T11
			{ spellID = 90166, size = 42, unitId = "player", caster = "player", filter = "BUFF" },
			--zerk
			{ spellID = 50334, size = 42, unitId = "player", caster = "player", filter = "BUFF" },
		...
		},
		{
			...
			-- Mangle/Zerfleischen
			{ spellID = 33876, size = 42, unitId = "target", caster = "all", filter = "DEBUFF" },
			-- Earth and Moon/Erde und Mond
			{ spellID = 48506, size = 42, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Faerie Fire/Feenfeuer
			{ spellID = 91565, size = 42, unitId = "target", caster = "all", filter = "DEBUFF" },
...
--[[		{
			...
			Interval = 4,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "RIGHT", -9, -88 },

			-- Tranqui
			{ spellID = 740, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "CD" },
			-- Innerv
			{ spellID = 20484, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "CD" },
			-- Rez
			{ spellID = 29166, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "CD" },
			-- barskin
			{ spellID = 22812, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "CD" },
			-- instinct
			{ spellID = 61336, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "CD" },
		},
--]]		
		
		{
			...
			Interval = 4,
			Mode = "BAR",
			setPoint = { "CENTER", -50, -70 },

			-- stampede
			{ spellID = 81022, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "BUFF" },
			
			-- rawr
			{ spellID = 77764, size = 24, barWidth = 200, unitId = "player", caster = "all", filter = "BUFF" },
			-- estro
			{ spellID = 22570, size = 24, barWidth = 200, unitId = "target", caster = "all", filter = "DEBUFF" },
	...
	["ALL"] = {
		...
		},
		{
			...
			--{ spellID = 50436, size = 64, unitId = "player", caster = "all", filter = "DEBUFF" },
			-- Hungering Cold
