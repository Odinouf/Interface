...
width = 70,
noIcon = true,
font = "Interface\\Addons\\QulightUI\\media\\1.ttf",
fontSize = 8,
})
...
if IsAddOnLoaded("alDamageMeter") then
	...
	dps:SetPoint("CENTER", UIParent, "BOTTOMRIGHT", RPx+50, RPy)
else
	...
	skada:SetPoint("CENTER", UIParent, "BOTTOMRIGHT", RPx+50, RPy)
...
equip:SetPoint("CENTER", UIParent, "BOTTOMRIGHT", RPx+210, RPy)
