...
function frame:UpdateGroupLoot()
	...
	for index, value in ipairs(grouplootlist) do
		...
		if ( not bar ) then
			...
			bar:SetStatusBarTexture(cfg.bartex);
			if ( index == 1 ) then
			...
			bar.background:SetTexture(cfg.bartex);
			...
			bar.border.topleft:SetTexture(cfg.bordertex);
			...
			bar.border.bottomleft:SetTexture(cfg.bordertex);
			...
			bar.border.topright:SetTexture(cfg.bordertex);
			...
			bar.border.bottomright:SetTexture(cfg.bordertex);
			...
			bar.border.top:SetTexture(cfg.bordertex);
			...
			bar.border.bottom:SetTexture(cfg.bordertex);
			...
			bar.border.left:SetTexture(cfg.bordertex);
			...
			bar.border.right:SetTexture(cfg.bordertex);
            ...
            bar.icon:SetSize(cfg.roll_iconsize,cfg.roll_iconsize)
            ...
            bar.iborder.topleft:SetTexture(cfg.bordertex);
            ...
            bar.iborder.bottomleft:SetTexture(cfg.bordertex);
            ...
            bar.iborder.topright:SetTexture(cfg.bordertex);
            ...
            bar.iborder.bottomright:SetTexture(cfg.bordertex);
            ...
            bar.iborder.top:SetTexture(cfg.bordertex);
            ...
            bar.iborder.bottom:SetTexture(cfg.bordertex);
            ...
            bar.iborder.left:SetTexture(cfg.bordertex);
            ...
            bar.iborder.right:SetTexture(cfg.bordertex);
