...
local MapPosition = {"BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -7, 23}
local zoneTextYOffset = 4		-- Zone text position
...
clockFrame:Hide()
clockTime:SetFont("Interface\\Addons\\QulightUI\\media\\1.ttf", 10, "THINOUTLINE")
...
MinimapZoneText:SetFont("Interface\\Addons\\QulightUI\\media\\1.ttf", 10, "THINOUTLINE")
